  ...
  return (
    <Fragment>
      <List classes={ { root: classes.list } }>
        ...
        >
          { hairColors.map((color, index) => (
            <div
              ...
              style={ {
                ...(hairColor === index && { backgroundColor: 'rgba(0, 0, 0, .2)' }),
              } }
            >
              { renderColor(index) }
            </div>
        ...
        >
          { hairColors.map((color, index) => (
            <div
              ...
              style={ {
                ...(eyebrowColor === index && { backgroundColor: 'rgba(0, 0, 0, .2)' }),
              } }
            >
              { renderColor(index) }
            </div>
        ...
        >
          { hairColors.map((color, index) => (
            <div
              ...
              style={ {
                ...(beardColor === index && { backgroundColor: 'rgba(0, 0, 0, .2)' }),
              } }
            >
              { renderColor(index) }
            </div>
        ...
        <SelectionOption
          label="Blush Color"
          options={ [...blushColors.values()] }
          value={ blushColors.get(blushColor) }
        ...
        >
          { hairColors.map((color, index) => (
            <div
              ...
              style={ {
                ...(chestHairColor === index && { backgroundColor: 'rgba(0, 0, 0, .2)' }),
              } }
            >
              { renderColor(index) }
            </div>
