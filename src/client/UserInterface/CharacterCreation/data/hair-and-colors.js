...
export const hairColors = [
    '#1a1917', '#302a25', '#3f3029', '#432318', '#6f371e', '#803c1f', '#7b4027',
    '#9c613f', '#956143', '#a77853', '#ba8e60', '#b38e62', '#bf9c6d', '#c89d5c',
    '#d9b16f', '#e8c28c', '#b38256', '#9d5739', '#a73f28', '#8c1210', '#ab1b13',
    '#be2117', '#d73f21', '#ec501e', '#c45732', '#d95126', '#917969', '#b09682',
    '#d5beaa', '#ecd7c3', /*'#eed7c3', '#955f78', '#bb5784', '#fb38d1', '#fe4b98',
    '#f89ead', '#099f93', '#148185', '#085081', '#66ac60', '#359466', '#206957',
    '#b8c02d', '#9fb915', '#58a321', '#e5b54e', '#f8cc16', '#f59b0e', '#fa8814',
    '#e65418', '#f3530f', '#e73916', '#ef3412', '#d70e10', '#bc090d', '#322019',
    '#42251d', '#572e1f', '#502d1f', '#552e20', '#3d261f', '#08090d', '#af8f6c',
    '#d5a76b',*/
];
...
export const MAX_HAIR_COLOR = hairColors.length;
export const MAX_EYE_COLOR = 32;
export const MAX_LIPSTICK_COLOR = 32;

const randomIndex = length => Math.random() * length | 0;
export const getRandomHair = gender =>
...
export const getRandomEyeColor = () => randomIndex(eyeColors);
